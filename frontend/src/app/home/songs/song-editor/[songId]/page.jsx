  ...
  return (
    <div className="relative bg-theme-gold/90 min-h-screen p-6">
      ...
      <div className="relative z-10 flex justify-center">
        <Card className="w-full max-w-3xl bg-[#fff5] shadow-lg">
          <CardHeader className="space-y-1">
            ...
            <p className="text-sm text-slate-800">
              {isEditing
                ? "Modify your song details below"
                : "Fill out the form to add a new song"}
            </p>
          </CardHeader>
                ...
                {hasBridge && bridge && (
                  <div className="bridge-shift flex flex-row items-center justify-center ml-auto mr-auto gap-1">
                    ...
                    <Button
                      ...
                      disabled={
                        structure.indexOf("bridge") == structure.length - 1
                      }
                    >
                      <ArrowDown />
                    </Button>
