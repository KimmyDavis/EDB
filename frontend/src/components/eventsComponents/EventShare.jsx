...
const MassShare = ({ eventId, className, iconOnly = false }) => {
  const [shareDialogOpen, setShareDialogOpen] = useState(false);

  const shareUrl =
    typeof window !== "undefined"
      ? `${window.location.origin}/home/events/event/${eventId}`
      : `https://example.com/home/events/event/${eventId}`;
      ...
      <Dialog open={shareDialogOpen} onOpenChange={setShareDialogOpen}>
        <DialogContent className="bg-[#fff9] supports-backdrop-filter:backdrop-blur-sm">
          <DialogHeader>
            ...
            <DialogDescription>
              Scan this QR code or copy the code below to share this event.
            </DialogDescription>
          </DialogHeader>
