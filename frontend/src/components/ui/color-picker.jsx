...
function ColorPickerTrigger(
  ...
  return (
    <PopoverTrigger
      disabled={isDisabled}
      render={<TriggerPrimitive data-slot="color-picker-trigger" {...triggerProps} />}></PopoverTrigger>
  );
}
...
export { ColorPicker, ColorPickerTrigger, ColorPickerContent, ColorPickerArea, ColorPickerHueSlider, ColorPickerAlphaSlider, ColorPickerSwatch, ColorPickerEyeDropper, ColorPickerFormatSelect, ColorPickerInput, //
